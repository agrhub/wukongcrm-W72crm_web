  ...
  <div class="address-book-index">
    <div class="header">
      <flexbox class="title">
        ...
        <span class="text">Số danh bạ</span>
      </flexbox>
      <el-input
    ...
    <div class="container container-hook">
      <flexbox class="filter">
        <span class="filter__label">Chọn phòng ban</span>
        <xh-structure-cell
...
export default {
  ...
  data() {
    return {
      ...
      listData: [],
      tableMap: [
        { label: 'Số di động', key: 'mobile' },
        { label: 'Phòng ban', key: 'deptName' },
        { label: 'Chức vụ', key: 'post' }
      ],
      tableHeight: 0,
      specialRowArr: [],
