  ...
  <el-drawer
    ...
    <flexbox v-if="editNode" class="drawer-header">
      ...
      <el-popover
        ...
        <el-button slot="reference" type="text">Cài đặt ưu tiên</el-button>
      </el-popover>
      ...
      <el-tooltip
        ...
        <template slot="content">
          Đầu tiên hãy khớp với điều kiện "ưu tiên cao".<br>Nếu thỏa mãn điều kiện, biểu mẫu chấp thuận được gửi đến người phê duyệt theo điều kiện này; <br> nếu không thỏa mãn điều kiện, nó sẽ tiếp tục phù hợp với điều kiện ưu tiên tiếp theo.
        </template>
    ...
    <div v-if="editNode" class="drawer-body">
          ...
          <flexbox
            ...
            <div style="flex: 1;">
              <wk-user-dep-select
                ...
                placeholder="Vui lòng chọn nhân viên hoặc bộ phận"
                style="width: 100%;"
              ...
              <role-employee-select
                ...
                multiple
                placeholder="Vui lòng chọn một vai trò"
                collapse-tags
      ...
      <div>
        <el-button type="text" icon="el-icon-plus" @click="conditionSelectClick">Thêm điều kiện</el-button>

        <el-tooltip
          effect="dark"
          placement="bottom">
          <template slot="content">
            <div style="font-weight: bold">Cách thêm các trường có điều kiện？</div>
            <div style="margin-top: 10px;line-height: 15px;">Bạn có thể thêm số, tiền tệ,<br >tùy chọn đơn hoặc nhiều lựa chọn và đặt nó theo yêu cầu.</div>
          </template>
          <i class="wk wk-help wk-help-tips"/>
        </el-tooltip>
      </div>
    ...
    <div class="drawer-footer">
      <el-button @click.native="close">Hủy bỏ</el-button>
      <el-button
  ...
  methods: {
    ...
    nameInputBlur() {
      ...
      if (this.editNode.conditionName === '') {
        this.editNode.conditionName = 'Điều kiện'
      }
    },
