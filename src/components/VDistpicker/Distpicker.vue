<template>
  <div :class="wrapper">
    <template v-if="type != 'mobile'">
      <el-select v-model="currentProvince" :disabled="disabled || provinceDisabled" placeholder="Tỉnh, thành phố" @change="getCities">
      ...
      <template v-if="!onlyProvince">
        <el-select v-model="currentCity" :disabled="disabled || cityDisabled" placeholder="Khu vực" @change="getAreas">
        ...
        <el-select v-if="!hideArea" v-model="currentArea" :disabled="disabled || areaDisabled" placeholder="Khu vực">
