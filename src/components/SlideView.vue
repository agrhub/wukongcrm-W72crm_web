    ...
    <el-card
      ...
      <el-dialog
        ...
        <div class="el-message-box__container" style="padding: 10px 15px 15px;">
          ...
          <div class="el-message-box__message">Bạn có chắc chắn thoát không? Nội dung đang được chỉnh sửa sẽ bị mất.</div>
        </div>
        <span slot="footer" class="dialog-footer">
          <el-button @click="dialogVisible = false">Hủy</el-button>
          <el-button type="primary" @click="dialogSure">Xác nhận</el-button>
        </span>
      </el-dialog>
    </el-card>
  </transition>
